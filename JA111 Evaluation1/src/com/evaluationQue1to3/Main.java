...
public class Main {
	...
	public static void printMonths(String x)
	{   
		String month=x;
		switch (month)
		{
			...
			case "JUN":System.out.println("This is the 5th Month of the Year June");
			break;
			case "JLY":System.out.println("This is the 7th Month of the Year July");
			break;
			
			case "AUS":System.out.println("This is the 8th Month of the Year August");
			break;
